 ...
 (defn
  ...
  (let
   [inverted
    (if
     (= i 1)
     (mapv (fn* [p1__104110#] (- (* 2 pivot) p1__104110#)) melody)
     melody)
    retrograded
      ...
      {:transform (v4-labels g),
       ...
       (str
        (mapv
         (fn*
          [p1__104111#]
          (get note-names p1__104111# (str p1__104111#)))
         result))}))
    (hm/elements V4))]
  (kind/table
...
(def
 ...
 (defn
  ...
  [k melody]
  (mapv (fn* [p1__104112#] (+ p1__104112# (long k))) melody)))
      ...
      [k
       (str
        (mapv
         (fn*
          [p1__104113#]
          (get note-names (mod p1__104113# 12) (str p1__104113#)))
         (mapv
          (fn* [p1__104114#] (+ 60 (mod (- p1__104114# 60) 12)))
          transposed)))]))
    (range 12))]
  (kind/table
 ...
 (defn
  ...
  (let
   [prime
    ...
    (first row)
    inversion
    (mapv (fn* [p1__104115#] (mod (- (* 2 pivot) p1__104115#) 12)) row)
    ri
   ...
   (vec
    (for
     ...
     {:label (str form-name (when (pos? k) k)),
      ...
      :transposition k,
      :row
      (mapv (fn* [p1__104116#] (mod (+ p1__104116# k) 12)) form)})))))
 ...
 (let
  [forms
   ...
   (filterv
    (fn*
     [p1__104117#]
     (contains? #{0 6 3 9} (:transposition p1__104117#)))
    forms)
   selected
