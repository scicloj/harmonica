    ...
    (fn
     ...
     (let
      [ct
       ...
       (reduce
        +
        (map (fn* [p1__125549#] (* p1__125549# p1__125549#)) dims))]
      {:group label,
       :pass?
       (<
     ...
     (let
      [n
       ...
       (apply
        +
        (map
         (fn* [p1__125550#] (* p1__125550# p1__125550#))
         (vec mag-f)))
       rhs
       (*
        (/ 1.0 (double n))
        (apply
         +
         (map
          (fn* [p1__125551#] (* p1__125551# p1__125551#))
          (vec mag-fh))))]
    ...
    (let
     [G
      ...
      (fn
       [g coloring]
       (mapv
        (fn* [p1__125552#] (coloring (mod (+ p1__125552# g) n)))
        (range n)))
      orbit-count
