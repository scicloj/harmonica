    ...
    (fn
     ...
     (let
      [ct
       ...
       (reduce
        +
        (map (fn* [p1__100389#] (* p1__100389# p1__100389#)) dims))]
      {:group label,
       :pass?
       (<
     ...
     (let
      [n
       ...
       (apply
        +
        (map
         (fn* [p1__100390#] (* p1__100390# p1__100390#))
         (vec mag-f)))
       rhs
       (*
        (/ 1.0 (double n))
        (apply
         +
         (map
          (fn* [p1__100391#] (* p1__100391# p1__100391#))
          (vec mag-fh))))]
    ...
    (let
     [G
      ...
      (fn
       [g coloring]
       (mapv
        (fn* [p1__100392#] (coloring (mod (+ p1__100392# g) n)))
        (range n)))
      orbit-count
    ...
    (let
     [G
      ...
      (fn
       [g coloring]
       (mapv
        (fn* [p1__100393#] (coloring (mod (+ p1__100393# g) n)))
        (range n)))
      burnside
