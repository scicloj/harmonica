    ...
    (fn
     ...
     (let
      [ct
       ...
       (reduce
        +
        (map (fn* [p1__77758#] (* p1__77758# p1__77758#)) dims))]
      {:group label,
       :pass?
       (<
    ...
    (fn
     ...
     (let
      [n
       ...
       (apply
        +
        (map (fn* [p1__77759#] (* p1__77759# p1__77759#)) (vec mag-f)))
       rhs
       (*
        (/ 1.0 (double n))
        (apply
         +
         (map
          (fn* [p1__77760#] (* p1__77760# p1__77760#))
          (vec mag-fh))))]
    ...
    (let
     [G
      ...
      (fn
       [g coloring]
       (mapv
        (fn* [p1__77761#] (coloring (mod (+ p1__77761# g) n)))
        (range n)))
      orbit-count
    ...
    (let
     [G
      ...
      (fn
       [g coloring]
       (mapv
        (fn* [p1__77762#] (coloring (mod (+ p1__77762# g) n)))
        (range n)))
      burnside
