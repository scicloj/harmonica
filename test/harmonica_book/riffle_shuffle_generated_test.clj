     ...
     ["**Total**"
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__137618#]
         (let [d (hm/hook-length-dimension p1__137618#)] (* d d)))
        parts))])})))
     ...
     (=
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__137619#]
         (let [d (hm/hook-length-dimension p1__137619#)] (* d d)))
        parts)))))
   v13_l74)))
   ...
   (Math/abs
    (-
     (reduce
      +
      (map
       (fn* [p1__137620#] (probs p1__137620#))
       (range (count elts))))
     1.0))
   1.0E-10)))
       ...
       (*
        ...
        (reduce
         ...
         (map
          (fn*
           [p1__137621#]
           (Math/abs (- (probs p1__137621#) uniform)))
          (range n-elts))))]
      {:k k, :tv tv}))
    (range 1 15))]
  (->
  ...
  [n
   ...
   (*
    ...
    (reduce
     +
     (map
      (fn* [p1__137622#] (Math/abs (- (probs p1__137622#) uniform)))
      (range n-elts))))]
  (> tv 0.5)))
  ...
  [n
   ...
   (*
    ...
    (reduce
     +
     (map
      (fn* [p1__137623#] (Math/abs (- (probs p1__137623#) uniform)))
      (range n-elts))))]
  (< tv 0.01)))
       ...
       (*
        ...
        (reduce
         ...
         (map
          (fn*
           [p1__137624#]
           (Math/abs (- (probs p1__137624#) uniform)))
          (range n-elts))))]
      {:k k, :tv tv, :n (str "n=" n)})))]
  (->
   (tc/dataset tv-data)
