     ...
     ["**Total**"
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__103719#]
         (let [d (hm/hook-length-dimension p1__103719#)] (* d d)))
        parts))])})))
     ...
     (=
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__103720#]
         (let [d (hm/hook-length-dimension p1__103720#)] (* d d)))
        parts)))))
   v9_l68)))
       ...
       (*
        ...
        (reduce
         ...
         (map
          (fn*
           [p1__103721#]
           (Math/abs (- (aget probs (int p1__103721#)) uniform)))
          (range n-elts))))]
      {:k k, :tv tv}))
    (range 1 15))]
  (->
       ...
       (*
        ...
        (reduce
         ...
         (map
          (fn*
           [p1__103722#]
           (Math/abs (- (aget probs (int p1__103722#)) uniform)))
          (range n-elts))))]
      {:k k, :tv tv, :n (str "n=" n)})))]
  (->
   (tc/dataset tv-data)
