     ...
     ["**Total**"
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__89612#]
         (let [d (hm/hook-length-dimension p1__89612#)] (* d d)))
        parts))])})))
     ...
     (=
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__89613#]
         (let [d (hm/hook-length-dimension p1__89613#)] (* d d)))
        parts)))))
   v13_l74)))
  ...
  (<
   (Math/abs
    (-
     (reduce
      +
      (map (fn* [p1__89614#] (probs p1__89614#)) (range (count elts))))
     1.0))
   1.0E-10)))
      ...
      [probs
       ...
       (*
        ...
        (reduce
         +
         (map
          (fn* [p1__89615#] (Math/abs (- (probs p1__89615#) uniform)))
          (range n-elts))))]
      {:k k, :tv tv}))
    (range 1 15))]
  (->
  ...
  [n
   ...
   (*
    ...
    (reduce
     +
     (map
      (fn* [p1__89616#] (Math/abs (- (probs p1__89616#) uniform)))
      (range n-elts))))]
  (> tv 0.5)))
  ...
  [n
   ...
   (*
    ...
    (reduce
     +
     (map
      (fn* [p1__89617#] (Math/abs (- (probs p1__89617#) uniform)))
      (range n-elts))))]
  (< tv 0.01)))
      ...
      [G
       ...
       (*
        ...
        (reduce
         +
         (map
          (fn* [p1__89618#] (Math/abs (- (probs p1__89618#) uniform)))
          (range n-elts))))]
      {:k k, :tv tv, :n (str "n=" n)})))]
  (->
   (tc/dataset tv-data)
