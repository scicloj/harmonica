     ...
     ["**Total**"
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__123524#]
         (let [d (hm/hook-length-dimension p1__123524#)] (* d d)))
        parts))])})))
     ...
     (=
      ...
      (reduce
       ...
       (map
        (fn*
         [p1__123525#]
         (let [d (hm/hook-length-dimension p1__123525#)] (* d d)))
        parts)))))
   v13_l74)))
   ...
   (Math/abs
    (-
     (reduce
      +
      (map
       (fn* [p1__123526#] (probs p1__123526#))
       (range (count elts))))
     1.0))
   1.0E-10)))
       ...
       (*
        ...
        (reduce
         ...
         (map
          (fn*
           [p1__123527#]
           (Math/abs (- (probs p1__123527#) uniform)))
          (range n-elts))))]
      {:k k, :tv tv}))
    (range 1 15))]
  (->
  ...
  [n
   ...
   (*
    ...
    (reduce
     +
     (map
      (fn* [p1__123528#] (Math/abs (- (probs p1__123528#) uniform)))
      (range n-elts))))]
  (> tv 0.5)))
  ...
  [n
   ...
   (*
    ...
    (reduce
     +
     (map
      (fn* [p1__123529#] (Math/abs (- (probs p1__123529#) uniform)))
      (range n-elts))))]
  (< tv 0.01)))
       ...
       (*
        ...
        (reduce
         ...
         (map
          (fn*
           [p1__123530#]
           (Math/abs (- (probs p1__123530#) uniform)))
          (range n-elts))))]
      {:k k, :tv tv, :n (str "n=" n)})))]
  (->
   (tc/dataset tv-data)
