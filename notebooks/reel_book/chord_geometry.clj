...
(let [G-c (reel/cyclic-group 12)
      ...
      orbs-c (reel/orbits G-c act-c-sub domain-3)
      orbs-d (reel/orbits G-d act-d-sub domain-3)
...
(let [G-c (reel/cyclic-group 12)
      ...
      act-d (fn [[t k] x]
              (case t
                ...
                :s (mod (- (long k) (long x)) 12)))
      results (mapv (fn [k]
                      (let [{domain-k :domain act-c-k :act} (reel/subset-action act-c (range 12) k)
                            {_ :domain act-d-k :act} (reel/subset-action act-d (range 12) k)
                            n-trans (count (reel/orbits G-c act-c-k domain-k))
                            n-dihed (count (reel/orbits G-d act-d-k domain-k))]
                        {:k k
...
(let [G (reel/cyclic-group 12)
      ...
      hat-a (reel/fourier-transform ct f-a)
      hat-b (reel/fourier-transform ct f-b)
